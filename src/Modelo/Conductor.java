...
public class Conductor extends PersonalConVehiculo{
    ...
    public Conductor(long licencia, long numCarnet, boolean activo, double salario, LocalDate fechaContrato, String tipo, String cedula, String nombre, String correo, String telefono, LocalDate nacimiento, char genero) {
